...
export const defaultUser = {
  ...
  username: "username",
  name: "name",
  profile_image: "https://robohash.org/hello",
  // profile_image:
...
export const defaultPost = {
  ...
  user: defaultUser,
  media:
    "https://www.onlineinterviewquestions.com/storage/posts/September2018/Uploading-An-Image-from-Facebook-to-local-disk-in-Node-jS-medium.jpg",
  comments: [],
