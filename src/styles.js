...
const sectionItem = {
  ...
  marginBottom: 16,
  gridTemplateColumns: "minmax(auto, 150px) minmax(auto, 500px)",
};
const typography = {
  fontWeight: "600 !important",
};
...
export const useEditProfilePageStyles = makeStyles((theme) => ({
  ...
  sectionItem: {
    ...sectionItem,
    [theme.breakpoints.down("xs")]: {
      gridTemplateColumns: "minmax(auto, 50px) minmax(auto, 500px)",
    },
  },
  form,
  typography,
  ...
  sectionItemWrapper: {
    ...sectionItem,
    [theme.breakpoints.down("xs")]: {
      gridTemplateColumns: "minmax(auto, 50px) minmax(auto, 340px)",
    },
    placeItems: "inherit",
    alignItems: "center",
  },
